...
\hline
C5AX & {\scriptsize\path{calculations/c5ax_reflection_retained_density.py}} & {\scriptsize\path{outputs/clean-start-c5ax-reflection-retained-density.md}} \\
\hline
C5AY & {\scriptsize\path{calculations/c5ay_reflection_covariant_retained_coordinates.py}} & {\scriptsize\path{outputs/clean-start-c5ay-reflection-covariant-retained-coordinates.md}} \\
\hline
C5AZ & {\scriptsize\path{calculations/c5az_shifted_coordinate_package_regression.py}} & {\scriptsize\path{outputs/clean-start-c5az-shifted-coordinate-package-regression.md}} \\
\hline
\end{longtable}
\end{center}
...
\hline
latest rerun folder & {\scriptsize\path{outputs/c5x-reproducibility-rerun/}} \\
\hline
latest SHA256 manifest & {\scriptsize\path{outputs/c5x-reproducibility-rerun/sha256_manifest.txt}} \\
\hline
...
The manifest is not copied into the prose because it changes whenever a controlled source changes.  The authoritative records are \path{outputs/c5x-reproducibility-rerun/manifest.json} and \path{sha256_manifest.txt}; every listed file path is relative to the project root.
