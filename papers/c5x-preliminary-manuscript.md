...
| M. Luscher, *Topology of lattice gauge fields*, Comm. Math. Phys. 85, 39--48 (1982), DOI `10.1007/BF02029132` | local lattice gauge fields under small-action/small-field hypotheses and compact group care | The principal-log chart used here is local and finite-block; global compact-gauge and continuum topological claims are outside scope. |
...
9. M. Luscher, *Topology of lattice gauge fields*, Communications in Mathematical Physics **85**, 39--48 (1982), DOI `10.1007/BF02029132`.
...
The author thanks the open-source scientific-computing community whose Python and numerical-linear-algebra tools were used for the finite-dimensional verification scripts.  Individual acknowledgements, if any, should be confirmed by the author before formal journal submission.

## Declarations

### Funding

No external funding information has been declared for this draft.  This statement should be confirmed by the author before formal submission.

### Competing interests

No competing interests have been declared for this draft.  This statement should be confirmed by the author before formal submission.

### Code and reproducibility availability

The finite-dimensional verification scripts, wrapper, and manifest structure are included in the accompanying reproducibility packet.  The current endorser-review packet contains the manuscript source, draft BibTeX file, reproducibility notes, selected scripts, and a packet manifest with SHA256 hashes.  A public repository release or archival DOI should be prepared before journal submission.

### AI-assisted work disclosure

OpenAI ChatGPT/Codex was used as an assistive tool for manuscript drafting, style revision, mathematical auditing, code generation, finite-dimensional numerical checks, and packaging.  The author remains responsible for the paper's claims, proofs, computations, citations, disclosures, and submission decisions.  No external submission, public repository update, or endorser contact should be made without explicit author approval.
